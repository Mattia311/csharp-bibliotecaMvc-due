...
namespace csharp_bibliotecaMvc_due.Data
{
    public class DbInitializer
    {
            ...
            var autore = new Autore[]
        {
            ...
            var libri = new Libro[]
           {
            new Libro{Titolo="I promessi sposi",Settore="Romanzi",Scaffale="s001", Stato=Stato.Disponibile, Autori = new List<Autore>{Magno}},
            new Libro{Titolo="I Malavoglia",Settore="Romanzi",Scaffale="s002", Stato=Stato.Disponibile, Autori = new List<Autore>{Magno}},
            new Libro{Titolo="Dune",Settore="FAntasi",Scaffale="s001", Stato=Stato.Prestito, Autori = new List<Autore>{Jo}},
